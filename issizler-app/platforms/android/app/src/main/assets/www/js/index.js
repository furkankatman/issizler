 ...
 * under the License.
 */
angular.module("issizlerApp", ['ngMaterial', 'ngSanitize', 'ngLocale', 'LocalStorageModule', 'ui.router', 'angular.filter']);
var app = {
    ...
    onDeviceReady: function () {
        ...
        angular.module("issizlerApp").config(function (localStorageServiceProvider, $stateProvider, $urlRouterProvider,
